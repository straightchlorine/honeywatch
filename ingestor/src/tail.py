...
# 1 MiB cap; typical Cowrie events ~64 KiB, bounds memory on attacker TTY payload.
MAX_LINE_BYTES = 1_048_576
# Drain cap prevents DoS from attacker sending infinite line without newline.
